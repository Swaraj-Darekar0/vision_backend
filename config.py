...
# CADENCE PROFILING
CADENCE_CALIBRATION_SESSIONS = 2
CADENCE_REVIEW_DAYS = 7
CADENCE_HISTORY_SESSIONS = 2

CADENCE_FAST_WPM_MIN = 170.0
CADENCE_PACER_WPM_MAX = 135.0
CADENCE_TEMPO_SIGMA_LOW = 10.0
CADENCE_TEMPO_SIGMA_HIGH = 28.0
CADENCE_PAUSE_FREQ_LOW = 1.8
CADENCE_PAUSE_FREQ_HIGH = 4.5
CADENCE_PAUSE_MEAN_SHORT = 0.35
CADENCE_PAUSE_MEAN_LONG = 0.75
CADENCE_RHYTHM_SIGMA_LOW = 0.18
CADENCE_RHYTHM_SIGMA_HIGH = 0.38
CADENCE_PITCH_SLOPE_RISE = 1.5
CADENCE_PITCH_SLOPE_FALL = -1.5
CADENCE_MIN_SILENCE_PAUSE_SECONDS = 0.25

CADENCE_DISPLAY_LABELS = {
    "fast_driver": "Fast-Paced",
    "measured_pacer": "Grounded",
    "melodic_speaker": "Expressive",
}

CADENCE_INSPIRATIONS = {
    "fast_driver": "Tony Robbins",
    "measured_pacer": "Martin Luther King Jr.",
    "melodic_speaker": "Barack Obama",
}

CADENCE_EVENT_WPM_BUFFER_FAST_DRIVER = 12.0
CADENCE_EVENT_WPM_BUFFER_MEASURED_PACER = -12.0
CADENCE_FILLER_HEAVY_THRESHOLD = 0.14
CADENCE_STUTTER_CLUSTER_THRESHOLD = 0.12
CADENCE_EXTENDED_PAUSE_THRESHOLD = 0.95
CADENCE_FILLER_PAUSE_SECONDS = 0.6
